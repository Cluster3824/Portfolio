  ...
  return (
    <section id="contact" className="contact">
      <div className="container">
        <h2>Let's Connect</h2>
        <p>I'm always excited to discuss new opportunities, collaborate on innovative projects, or simply connect with fellow developers and AI enthusiasts. Whether you're interested in LLM agent development, machine learning research, or full-stack development, Good to hear from you!</p>
